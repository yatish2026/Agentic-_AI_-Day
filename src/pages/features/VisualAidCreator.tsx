...
export const VisualLearning = () => {
  const [aids, setAids] = useState<VisualAid[]>(visualAids);
  const [selectedAid, setSelectedAid] = useState<VisualAid | null>(visualAids[0]);
  const [searchTerm, setSearchTerm] = useState("water cycle");
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-xs bg-indigo-600/60 text-white px-2 py-1 rounded">{aid.subject}</span>
                          <span className="text-xs bg-slate-700 text-white px-2 py-1 rounded">{aid.type}</span>
                        </div>
                      </div>
                    </div>
                    <Button
                ...
                {selectedAid.hasVideo && selectedAid.videoUrl && (
                  <div className="bg-blue-900/30 p-4 rounded-lg mb-4">
                    <div className="flex items-center justify-center gap-2 mb-2">
                      ...
                      <span className="text-sm font-medium text-cyan-300">Interactive Video Available</span>
                    </div>
                    <iframe
